...
class FeatureAdapter (private val context: Context, private val lstFeatureCard: MutableList<Feature_Item>): RecyclerView.Adapter<FeatureAdapter.FeatureViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): FeatureViewHolder {
        val itemView= LayoutInflater.from(parent.context).inflate(R.layout.card_feature, parent, false)
